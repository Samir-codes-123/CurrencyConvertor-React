import { Link, NavLink } from "react-router-dom"; //link to replace a beacuse a causes page refresh
            ...
            <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
              <li>
                <NavLink
                  to="/"
                  className={(
                    { isActive }, // if the page is active or we are in that that page then color change in navbar
                  ) =>
